    ...
    return (
        <>
            ...
            <div className='nunito-500 ml-[250px] tracking-wide'>
                <div className='fixed top-0 w-full bg-[#F9F9F9] pl-10 py-5'>
                ...
                <div className='flex flex-col gap-10 pl-10 py-32'>
                    ...
                    <div className='flex flex-col gap-2 w-[600px]'>
                        ...
                        <textarea name="" id="" cols="20" rows="5" placeholder='Input the video title' className='border border-[#DCDCDC] tracking-wide rounded-md py-2 px-5 outline-none  placeholder:text-[14px]'></textarea>
                    </div>
                    <p className='bg-[#FF7272] text-white nunito-700 text-[14px] py-3 px-5 rounded-md w-fit'>Upload video</p>
                </div>
            </div>
        </>
    )
