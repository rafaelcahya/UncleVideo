                    ...
                    <div className='flex flex-col gap-10'>
                        ...
                        <form className='nunito-500 flex flex-col gap-7'>  
                            <div className='flex flex-col items-start gap-3 focus-within:text-[#AB59FF]'>
                                ...
                                <input type="text" placeholder='Input your username' className='nunito border border-[#C9C9C9] focus-within:border-[#AB59FF] text-black w-[350px] text-[14px] px-5 py-2.5 rounded-md outline-none tracking-wide'/>
                            </div>
                            <div className='flex flex-col items-start gap-3 focus-within:text-[#AB59FF]'>
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <Link to='/' className='nunito-600 text-[14px] bg-[#AB59FF] text-white text-center py-2.5 rounded-md cursor-pointer'>Sign in</Link>
                        </div>
                    </div>
                </div>
            </div>
